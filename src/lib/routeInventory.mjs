...
export const STATIC_PUBLIC_ROUTES = [
  ...
  '/guider',
  '/guider/mina-forsta-hons',
  '/guider/mina-forsta-hons/tack',
  '/guider/mina-forsta-hons/hamta',
  '/guider/vinterklar-honsgard',
  '/guider/vinterklar-honsgard/tack',
  '/guider/vinterklar-honsgard/hamta',
  '/guider/aggbodens-saljpaket',
  '/guider/aggbodens-saljpaket/tack',
  '/guider/aggbodens-saljpaket/hamta',
  '/guider/fran-honsgard-till-aggbod',
  '/guider/fran-honsgard-till-aggbod/tack',
  '/guider/fran-honsgard-till-aggbod/hamta',
  '/guider/klackdagboken',
  '/guider/klackdagboken/tack',
  '/guider/klackdagboken/hamta',
